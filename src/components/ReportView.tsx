...
import type { AnalysisReport, ReportSection, ReportSectionGroup, ReportSubscore } from '@/types/report';
import { Badge } from '@/components/ui/badge';
import { Button } from '@/components/ui/button';
import { Card, CardContent } from '@/components/ui/card';
import { formatNumber, getScoreColor } from '@/components/report/reportUtils';
import { getGradeColor } from '@/components/report/reportUtils';
import SubscoreRadarChart from '@/components/report/SubscoreRadarChart';
import GradeProgressBar from '@/components/report/GradeProgressBar';
